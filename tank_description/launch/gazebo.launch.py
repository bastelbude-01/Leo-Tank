...
def generate_launch_description():
    ...
    model_arg = DeclareLaunchArgument(
        ...
        default_value=os.path.join(get_package_share_directory(
            "tank_description"), "urdf", "leopard.urdf.xacro"),
    ...
    env_var = SetEnvironmentVariable("GAZEBO_MODEL_PATH", os.path.join(get_package_prefix("tank_description"), "share"))
    ...
    spawner_robot = Node(
        ...
        arguments=["-entity", "leopard","-topic", "robot_description"],
        output="screen"
    )

#ifndef TANK_INTERFACE_HPP
#define TANK_INTERFACE_HPP
...
class TankInterface : public hardware_interface::SystemInterface
{
public:
    TankInterface();
    virtual ~TankInterface();
